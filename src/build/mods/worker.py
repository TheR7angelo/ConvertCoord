...
class Worker_export_bdd(QRunnable):
    ...
    def run(self):
        ...
        def bdd_req(data, date):  # sourcery no-metrics
            def req(data, date):
                for key in data:
                    try:
                ...
                bdd = {"ap_id": f"{data['Nom Appui']}/{data['Code Insee']}/{data['Adresse (rue)']}",
                       ...
                       "ap_tvx": data['Travaux'],
                       "ap_n_app": data["Poteaux replacement"],
